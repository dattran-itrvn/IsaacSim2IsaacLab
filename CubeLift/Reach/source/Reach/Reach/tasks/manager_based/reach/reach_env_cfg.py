...
class ReachSceneCfg(InteractiveSceneCfg):
    ...
    def __post_init__(self):
        ...
        self.ee_frame = FrameTransformerCfg(
            prim_path="{ENV_REGEX_NS}/Robot/ur_gripper/world",
            debug_vis=True,
            visualizer_cfg=marker_cfg,
            target_frames=[
                FrameTransformerCfg.FrameCfg(
                    prim_path="{ENV_REGEX_NS}/Robot/ur_gripper/wrist_3_link",
                    name="end_effector",
                    offset=OffsetCfg(
                        pos=[0.0, 0.0, 0.2],
                    ),
...
class RewardsCfg:
    ...
    object_goal_tracking = RewTerm(
        ...
        params={"std": 0.3, "minimal_height": 0.04, "command_name": "ee_pose"},
        weight=16.0,
    )
    object_goal_tracking_fine_grained = RewTerm(
        func=mdp.object_goal_distance,
        params={"std": 0.05, "minimal_height": 0.04, "command_name": "ee_pose"},
        weight=5.0,
    )
